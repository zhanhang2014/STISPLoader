...
* Version            : v0.0.0
* Date               : 
* Description        : Implements the CSTImage class interface
********************************************************************************
* More comments
*******************************************************************************/
...
CSTImage::CSTImage(BYTE bAlternate, BOOL bNamed, PSTR Name)
{
...
CSTImage::CSTImage(CSTImage *pSource)
{
	int i;
...
CSTImage::CSTImage(PMAPPING pMapping, BOOL bNamed, PSTR Name)
{
...
CSTImage::CSTImage(BYTE bAlternate, CString pFilePath, BOOL bNamed, PSTR Name)
{
...
BOOL CSTImage::DumpToFile(CString pFilePath)
{
...
BOOL CSTImage::LoadS19(CString pFilePath)
{
...
BOOL CSTImage::LoadBIN(CString pFilePath)
{
	CFile File;
	CFileException ex;
...
BOOL CSTImage::LoadHEX(CString pFilePath)
{
	IMAGEELEMENT Element, *pPrevElement;
	BOOL bRet = TRUE;
	FILE *fp;
...
BOOL CSTImage::SaveS19(CString pFilePath)
{
	IMAGEELEMENT Element;
	BOOL bRet = TRUE;
	FILE *fp;
...
BOOL CSTImage::SaveHEX(CString pFilePath)
{
	IMAGEELEMENT Element;
	BOOL bRet = TRUE;
	FILE *fp;
...
BOOL	CSTImage::SetImageElement(DWORD dwRank, BOOL bInsert, IMAGEELEMENT Element)
{
...
BOOL	CSTImage::GetImageElement(DWORD dwRank, PIMAGEELEMENT pElement)
{
...
BOOL	CSTImage::DestroyImageElement(DWORD dwRank)
{
	PIMAGEELEMENT pElement;
...
BOOL	CSTImage::FilterImageForOperation(PMAPPING pMapping, DWORD Operation, BOOL bTruncateLeadFF)
{
	int el;
	int sec;
...
BOOL CSTImage::ExistsElementsAtAddress(DWORD Address)
{
	int el;
	BOOL bRet = FALSE;
...
BOOL CSTImage::GetBuffer(DWORD dwAddress, DWORD dwSize, PBYTE pBuffer)
{
	int el;
	DWORD elStart, elEnd, secStart, secEnd;
